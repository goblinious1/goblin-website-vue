    ...
    <GlassContainer id="dropdowns">
      ...
      <ClickableGlass title="Funny little js thingies!" expandable="true" width="90%">
        ...
        <ul>
          ...
          <li><pre><code>javascript:document.body.contentEditable = !javascript:document.body.contentEditable</pre></code></li>
